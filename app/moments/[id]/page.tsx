  ...
  return (
    <main className="bg-stone-50 px-6 py-12 text-stone-800 sm:py-16">
      <section className="mx-auto max-w-2xl">
        ...
        <section className="mt-8 rounded-2xl border border-stone-200 bg-amber-50 p-6 shadow-sm sm:p-8">
        ...
        <section className="mt-5 rounded-2xl border border-stone-200 bg-amber-50 p-6 shadow-sm sm:p-8">
